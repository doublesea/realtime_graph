...
> **v2.2 大规模信号支持** - 支持最多 100 个信号同时显示，完善枚举值功能
...
### v2.2 (2025-11-18) - 大规模信号支持
- ✅ 支持最多 100 个信号同时显示（从 20 个增加到 100 个）
- ✅ 修复枚举值映射更新问题（切换信号数量时正确更新）
- ✅ 修复垂直指示线高度问题（确保贯穿所有子图）
- ✅ 优化代码结构，移除调试输出
- ✅ 改进枚举标签更新机制，使用 `ui.run_javascript` 实时更新
